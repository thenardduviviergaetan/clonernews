 ...
 */
//C'est la func qui autorise et limite l'affichage des données ou l'execution des funcs avec le delay, le leading et le trailing
...
//C'est la func main qui va récupèrer les élèments htmls ainsi que les données de l'api 
//On gère également la mise en page des données grace à displayPost
const fetchData = async () => {
    ...
    console.log(`${baseUrl}${currentSection}.json`)
...
//ensemble de mini throttle servant à charger les posts en fonction des actions attribués 
...
//Charge de nouveaux posts (en théorie, à un moment ca à buguer donc bon je sais pas comment le prendre)
