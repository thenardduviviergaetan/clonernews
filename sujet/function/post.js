 ...
 */
//Calcule le temps à effectué sur le fetch
...
//Retourne la data traduit
async function data(str) {
    let response = await fetch(str)
    return await response.json()
}

//Body du post avec création des élèments et stylisation des posts
class Post {
    constructor(post) {
        this.id = post.id
        this.author = post.by
...
//Body du commentaire avec création des élèments et stylisation des posts
class Comment {
    constructor(comment) {
        this.id = comment.id
...
//permet d'appendChild la class Post en tant que divElement Html
